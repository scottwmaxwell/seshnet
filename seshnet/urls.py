...
urlpatterns = [
    ...
    path('adminsettings/user_roles', users_views.userRoles, name="adminsettings"),
    path('adminsettings/serversettings', users_views.serverSettings, name="serversettings"),
